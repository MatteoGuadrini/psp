...
Each variables in each files correspond to a specific value, used by `psp` to substitute into handlebars template. These variables is listed below.
...
| `ACTIONS`         | Makefile actions like _"all|test|build"_                     |
