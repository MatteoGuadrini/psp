...
- Add git _custom_ server
- Add fallback value into _create_template_ function
- Add _PSP_CACHE_ and _PSP_TEMPLATES_ variables
- Add **utils** and **projects** module
- Add **ExitStatus** type alias

### Changed

- Change license clause on _pyproject.toml_
- Change lowercase "no" value into _prj_deps_ function
...
- Change repository of templates to [psp_templates](https://github.com/MatteoGuadrini/psp_templates)

### Fixed

- Change license clause on _pyproject.toml_
- Fix requirements variable for _travis_
- Fix tab from dependencies list into _tox.ini_ file
